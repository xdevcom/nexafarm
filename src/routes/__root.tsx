...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NexaFarm — The Future of DeFi Staking on BSC" },
      { name: "description", content: "Stake USDT on BNB Smart Chain. Earn daily ROI, referral rewards, and leadership bonuses with NexaFarm." },
      { name: "author", content: "NexaFarm" },
      { property: "og:title", content: "NexaFarm — DeFi Staking on BSC" },
      { property: "og:description", content: "Stake USDT, earn daily ROI, build your team, maximize your earnings." },
